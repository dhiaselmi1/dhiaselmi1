...
🔭 I'm currently working on cutting-edge full-stack development and artificial intelligence projects. My work spans from building interactive web applications like AURA (AI-powered financial assistant) to exploring real-world AI solutions that can make a significant impact.
...
💼 **Actively seeking internship and part-time opportunities** in:
- Full-Stack Development
- Artificial Intelligence & Machine Learning
- Web Development & Mobile Applications
- Software Engineering roles where I can contribute and learn

💻 My technical expertise includes:
- **Backend**: Java (Spring Boot), FastAPI (Python), Flask
- **Frontend & Mobile**: React, Ionic, Angular, Streamlit (Python), TailwindCSS
- **Programming Languages**: Python, JavaScript, C, C++, Java
- **Databases**: PostgreSQL, Oracle, SQLite, MongoDB
- **AI & LLMs**: Google Gemini AI, Mistral, LLaMA2, Deepseek-Coder via Ollama
- **Tools & Technologies**: Git, GitHub, Vite, Node.js, Express
